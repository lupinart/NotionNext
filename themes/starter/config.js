...
const CONFIG = {
  ...
  STARTER_LOGO_WHITE: '/images/starter/logo/logo_white.svg', // 透明底浅色logo 示例： /images/starter/logo/logo-white.svg
  ...
  // 英雄区配图，如需隐藏，改为空值即可 ''
  STARTER_HERO_PREVIEW_IMAGE: '', // 产品预览图 ，默认读取public目录下图片images/starter/hero/hero-image.webp
  ...
  STARTER_ABOUT_BUTTON_URL: 'https://www.lupinvisual.com/about',
  ...
  STARTER_FOOTER_SLOGAN: '用插畫與設計，將故事轉化為體驗。',
