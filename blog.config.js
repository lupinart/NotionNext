...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '26c5d9d8281181549f7ac86c3eea545d,en:',
  ...
  LANG: process.env.NEXT_PUBLIC_LANG || 'zh-TW', 'en-US'// e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Lupin', // 您的昵称 例如 tangly1024
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/Licon.svg', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个插畫師, Hi，我是一個設計師,Hi，我是一個美術人',
